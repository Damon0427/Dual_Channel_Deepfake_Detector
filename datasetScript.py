"""
    This Script is provided from FaceForensics to download the dataset
    It allows you to select which dataset, compression, type of files, 
    number of videos and server to download from.
"""
